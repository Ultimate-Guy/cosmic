(() => {
  ...
  const COMMAND_GROUPS = [
    {title:'🌐 Global',commands:[
      ...
      ['/announcement [text]','LIVE GLOBAL — appears only to users currently on Cosmic when published. A later visit does not replay it.'],
      ['/globalnotice [text]','PERSISTENT GLOBAL — remains available and appears the next time users open Cosmic.'],
  ...
  function renderGlobalState(data){
    ...
    document.getElementById('cosmic-global-state-stack')?.remove();
