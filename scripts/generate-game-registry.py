...
def fix_updates_flow():
    ...
    manifest='<link rel="manifest" href="../../manifest.json">';loader='<script src="../../scripts/cosmic-hub.js?v=1"></script><script src="../../scripts/cosmic-admin-guard.js?v=1"></script><script src="../../scripts/cosmic-launch-fix.js?v=1"></script>'
