(() => {
  ...
  function feedbackSuggest(){feedbackForm('Suggest an app or game','Tell Cosmic what you want added.','suggest');}
  ...
  async function boot(){
    ...
    // Universal game/app page stats bridge: games can report a score with postMessage({type:'cosmic-score',score}).
