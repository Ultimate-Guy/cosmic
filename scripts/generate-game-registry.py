...
SETTINGS_SCRIPT='<script id="cosmic-settings-engine-loader">(()=>{const s=document.createElement(\'script\');s.id=\'cosmic-settings-engine\';s.src=\'https://ultimate-guy.github.io/cosmic/settings/settings-engine.js?v=engine3\';document.head.appendChild(s);})();</script>\n'
