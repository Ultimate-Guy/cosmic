...
GAME_GUARD='<script id="cosmic-game-guard-loader" src="../../../scripts/game-guard.js?v=guard"></script>\n'
SETTINGS_SCRIPT='<script id="cosmic-settings-engine-loader">(()=>{const s=document.createElement(\'script\');s.id=\'cosmic-settings-engine\';s.src=new URL(\'../../../settings/settings-engine.js\',window.location.href).href;document.head.appendChild(s);})();</script>\n'
